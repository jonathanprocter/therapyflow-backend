        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {sessionPrep.keyTopics.length > 0 && (
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Key Topics to Address</h4>
            ...
            {sessionPrep.therapeuticQuestions.length > 0 && (
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Therapeutic Questions</h4>
            ...
            {sessionPrep.riskAssessment && (
              <div>
                ...
                <p className="text-sm text-gray-600">{sessionPrep.riskAssessment}</p>
              </div>
            )}
          </CardContent>
        </Card>
